...
;;; .fadeIn( [duration ] [, complete ] )Returns: jQuery
;;; Description: Display the matched elements by fading them to opaque.
;;; https://api.jquery.com/fadeIn/


;;; version added: 1.0.fadeIn( [duration ] [, complete ] )
...
;;;                                  If false, the animation will begin immediately. As of jQuery 1.7, 
;;;                                  the queue option can also accept a string, in which case the animation 
;;;                                  is added to the queue represented by that string. When a custom queue name 
;;;                                  is used the animation does not automatically start; you must 
;;;                                  call .dequeue("queuename") to start it.
...
;;;                                  A function to be called after each step of the animation, only once per animated 
;;;                                  element regardless of the number of animated properties. (version added: 1.8)
